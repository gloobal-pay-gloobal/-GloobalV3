// src/data/banks.js
var PALETTE = ["#DE2910", "#005EB8", "#21A038", "#EE2E24", "#8B0000", "#6A1B9A", "#00695C", "#B71C1C", "#0F52BA", "#F57C00"];
var BANK_NAMES = {
  ...
  FR: [["BNP Paribas", "BNP", "bnpparibas.com"], ["Cr\xE9dit Agricole", "CA", "credit-agricole.com"], ["Soci\xE9t\xE9 G\xE9n\xE9rale", "SG", "societegenerale.com"], ["BPCE", "BPCE", "groupebpce.com"], ["Cr\xE9dit Mutuel", "CM", "creditmutuel.fr"], ["La Banque Postale", "LBP", "labanquepostale.fr"], ["HSBC France", "HSBC", "hsbc.fr"], ["LCL", "LCL", "lcl.fr"], ["CIC", "CIC", "cic.fr"], ["AXA Banque", "AXA", "axabanque.fr"]],
  IT: [["Intesa Sanpaolo", "ISP", "intesasanpaolo.com"], ["UniCredit", "UCG", "unicredit.eu"], ["Banco BPM", "BPM", "bancobpm.it"], ["BPER Banca", "BPER", "bper.it"], ["Monte dei Paschi di Siena", "MPS", "mps.it"], ["Mediobanca", "MB", "mediobanca.com"], ["Cr\xE9dit Agricole Italia", "CAI", "credit-agricole.it"], ["Banca Pop. di Sondrio", "BPS", "popso.it"], ["Cassa Depositi e Prestiti", "CDP", "cdp.it"], ["Iccrea Banca", "ICCR", "iccrea.bcc.it"]],
  BR: [["Ita\xFA Unibanco", "ITAU", "itau.com.br"], ["Banco do Brasil", "BB", "bb.com.br"], ["Bradesco", "BRAD", "bradesco.com.br"], ["Caixa Econ\xF4mica Federal", "CEF", "caixa.gov.br"], ["Santander Brasil", "SAN", "santander.com.br"], ["BTG Pactual", "BTG", "btgpactual.com"], ["Banco Safra", "SAFRA", "safra.com.br"], ["Banco Votorantim", "BV", "bv.com.br"], ["Banco Inter", "INTER", "bancointer.com.br"], ["Nubank", "NU", "nubank.com.br"]],
  ...
  MX: [["BBVA M\xE9xico", "BBVA", "bbva.mx"], ["Banorte", "GFNO", "banorte.com"], ["Citibanamex", "BNMX", "banamex.com"], ["Santander M\xE9xico", "SAN", "santander.com.mx"], ["HSBC M\xE9xico", "HSBC", "hsbc.com.mx"], ["Scotiabank M\xE9xico", "BNS", "scotiabank.com.mx"], ["Banco Azteca", "AZTC", "bancoazteca.com.mx"], ["Inbursa", "INB", "inbursa.com"], ["Banregio", "BREG", "banregio.com"], ["Banco del Baj\xEDo", "BAJIO", "bancodelbajio.com.mx"]],
  ...
  CH: [["UBS", "UBS", "ubs.com"], ["Credit Suisse", "CS", "credit-suisse.com"], ["Z\xFCrcher Kantonalbank", "ZKB", "zkb.ch"], ["Raiffeisen Switzerland", "RAIF", "raiffeisen.ch"], ["PostFinance", "POST", "postfinance.ch"], ["Julius Baer", "BAER", "juliusbaer.com"], ["Pictet", "PCTE", "pictet.com"], ["Banque Cantonale Vaudoise", "BCV", "bcv.ch"], ["Basler Kantonalbank", "BKB", "bkb.ch"], ["EFG International", "EFG", "efginternational.com"]],
  TR: [["Ziraat Bankas\u0131", "ZIRT", "ziraatbank.com.tr"], ["T\xFCrkiye \u0130\u015F Bankas\u0131", "ISBK", "isbank.com.tr"], ["Garanti BBVA", "GRNT", "garantibbva.com.tr"], ["Akbank", "AKBK", "akbank.com"], ["Yap\u0131 Kredi", "YAPI", "yapikredi.com.tr"], ["Vak\u0131fBank", "VKFB", "vakifbank.com.tr"], ["Halkbank", "HALK", "halkbank.com.tr"], ["QNB Finansbank", "QNB", "qnbfinansbank.com"], ["Denizbank", "DNZ", "denizbank.com"], ["T\xFCrk Ekonomi Bankas\u0131", "TEB", "teb.com.tr"]]
};
var TOP5_ORDER_OVERRIDE = {
...
function logoUrlForDomain(domain, size = 128) {
  return domain ? `https://logo.clearbit.com/${domain}?size=${size}` : null;
}
function buildBanks(countryCode, dial) {
  const all = BANK_NAMES[countryCode] || [];
  const order = TOP5_ORDER_OVERRIDE[countryCode];
  const top5 = order ? order.map((name) => all.find((entry) => entry[0] === name)).filter(Boolean) : all.slice(0, 5);
...
var BANKS_BY_COUNTRY = Object.fromEntries(
